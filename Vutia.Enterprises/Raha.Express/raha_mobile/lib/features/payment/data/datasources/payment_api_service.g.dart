...
class _PaymentApiService implements PaymentApiService {
  ...
  Future<MpesaSTKResponse> initiateMpesaPayment(
    ...
    _data.addAll(body);
    final _options = _setStreamType<MpesaSTKResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late MpesaSTKResponse _value;
    try {
      _value = MpesaSTKResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<FamilyBankSTKResponse> initiateFamilyBankPayment(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<FamilyBankSTKResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late FamilyBankSTKResponse _value;
    try {
      _value = FamilyBankSTKResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
